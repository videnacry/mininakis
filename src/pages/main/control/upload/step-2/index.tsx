...
const StepTwo = (props:typeStep) => {
    ...
    const setDaysValue = useCallback(({currentTarget:{value}}) => ifNumberBetween(0, 10000000, Number(value), (value:number) => props.dispatchUpload(new uploadReducer.ActionSetDaysNumber(value))), [])
    ...
    return(
        ...
        {isDisplayedModalPrice ? 
            <ModalTwiceInputsNumber closeClickHandler={isDisplayedModalPriceFalse} inputsProps={[{labelText:'dollars', value: props.stateUpload.dollarsNumber, changeHandler: setDollarsValue}, {labelText:'cents', value:props.stateUpload.centsNumber, changeHandler: setCentsValue}]}/>
            : 
        ...
        {isDisplayedModalTimeLapse ? 
            <ModalTwiceInputsNumber closeClickHandler={setIsDisplayedModalTimeLapseFalse} inputsProps={[{labelText:'days', value: props.stateUpload.daysNumber, changeHandler: setDaysValue}, {labelText:'hours', value:props.stateUpload.hoursNumber, changeHandler: setHoursValue}]}/>
            : 
